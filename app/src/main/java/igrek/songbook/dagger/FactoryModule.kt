...
open class FactoryModule(private val activity: AppCompatActivity) {
    ...
    @Provides
    @Singleton
    fun aSongExportFileChooser(): SongExportFileChooser = SongExportFileChooser()
    ...
    @Provides
    @Singleton
    fun aCustomSongsLayoutController(): CustomSongsListLayoutController = CustomSongsListLayoutController()
