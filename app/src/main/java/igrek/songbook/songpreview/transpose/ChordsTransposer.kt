...
class ChordsTransposer(private val chordsNotation: ChordsNotation) {
    ...
    companion object {
         ...
         */
        val germanSoundNames = arrayOf(
                // minor
                "c", "c#", "d", "d#", "e", "f", "f#", "g", "g#", "a", "b", "h",
                // major
                "C", "C#", "D", "D#", "E", "F", "F#", "G", "G#", "A", "B", "H")

        val germanFisSoundNames = arrayOf(
                "c", "cis", "d", "dis", "e", "f", "fis", "g", "gis", "a", "b", "h",
                "C", "Cis", "D", "Dis", "E", "F", "Fis", "G", "Gis", "A", "B", "H")

        val englishSoundNames = arrayOf(
         ...
         */
        val soundNumbers: MutableMap<String, Int> = TreeMap(lengthComparator)

        init {
            for (i in germanSoundNames.indices) {
                soundNumbers[germanSoundNames[i]] = i
            }
        }
    }

    private val chordsNotationSoundNames: Array<String>
        get() {
            return when (chordsNotation) {
                ChordsNotation.GERMAN -> germanSoundNames
                ChordsNotation.GERMAN_IS -> germanFisSoundNames
                ChordsNotation.ENGLISH -> englishSoundNames
            }
        }
    ...
    private fun getChordNumber(chord: String): Int? {
        return soundNumbers[chord]
    }

    private fun getChordName(chordNr: Int): String? {
        val soundNames = chordsNotationSoundNames
